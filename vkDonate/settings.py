...
"""
Django settings for vkDonate project.
...
SECRET_KEY = '7w7kg#fc)pns1v%l63xh6t$7q94^%n)@08k3!+259j8(c_j+uh'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'displaySite.views.processor'
            ],
        },
    },
]

WSGI_APPLICATION = 'vkDonate.wsgi.application'
...
AUTHENTICATION_BACKENDS = (
    'authorization.auth_backend.PasswordlessAuthBackend',
